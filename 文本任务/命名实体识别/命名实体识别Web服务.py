...
<body>
    ...
    <script>
        ...
        function displayResult(data) {{
            ...
            html += '<div class="legend-item"><div class="legend-color" style="background: linear-gradient(135deg, #ff9800 0%, #f57c00 100%);"></div><span>👤 人名</span></div>';
            html += '<div class="legend-item"><div class="legend-color" style="background: linear-gradient(135deg, #2196f3 0%, #1976d2 100%);"></div><span>📍 地名</span></div>';
            html += '<div class="legend-item"><div class="legend-color" style="background: linear-gradient(135deg, #4caf50 0%, #388e3c 100%);"></div><span>🏢 机构</span></div>';
            html += '<div class="legend-item"><div class="legend-color" style="background: linear-gradient(135deg, #9c27b0 0%, #7b1fa2 100%);"></div><span>🏷️ 其他</span></div>';
            html += '</div>';
